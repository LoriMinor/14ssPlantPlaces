...
public class AdvancedSearchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// allows access to the auto complete text where the user types in a term to search.
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == RESULT_OK) {
			...
			if (requestCode == PLANT_RESULTS) {
				...
				// received a response from the image gallery.
	...
	public void onSelectAPictureClick(View v) {
		...
		// gives path where images are stored.
		String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getPath();

		// Convert to URI, Gallery is expecting.
